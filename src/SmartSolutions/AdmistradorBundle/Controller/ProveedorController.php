...
use SmartSolutions\AdmistradorBundle\Entity\Proveedor;
use SmartSolutions\AdmistradorBundle\Form\ProveedorType;
...
class ProveedorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SmartSolutionsAdmistradorBundle:Proveedor')->findAll();

        return $this->render('SmartSolutionsAdmistradorBundle:Proveedor:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('SmartSolutionsAdmistradorBundle:Proveedor:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SmartSolutionsAdmistradorBundle:Proveedor')->find($id);
        ...
        return $this->render('SmartSolutionsAdmistradorBundle:Proveedor:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('SmartSolutionsAdmistradorBundle:Proveedor:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    {
        $em = $this->getDoctrine()->getManager();
        $proveedor = $em->getRepository('SmartSolutionsAdmistradorBundle:Proveedor')->find($id);
